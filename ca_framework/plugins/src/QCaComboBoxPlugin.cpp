/* $File: //ASP/Dev/SBS/4_Controls/4_8_GUI_Frameworks/4_8_2_Qt/sw/ca_framework/plugins/src/QCaComboBoxPlugin.cpp $
 * $Revision: #1 $
...
/*!
    ???
*/
QCaComboBoxPlugin::QCaComboBoxPlugin( QWidget *parent ) : QCaComboBox( parent ) {
...
*/
void QCaComboBoxPlugin::useNewVariableNameProperty( QString variableNameIn, QString variableNameSubstitutionsIn, unsigned int variableIndex ) {
