/* $File: //ASP/Dev/SBS/4_Controls/4_8_GUI_Frameworks/4_8_2_Qt/sw/ca_framework/plugins/src/QCaSliderPlugin.cpp $
 * $Revision: #1 $
...
/*!
    ???
*/
QCaSliderPlugin::QCaSliderPlugin( QWidget *parent ) : QCaSlider( parent ) {
...
*/
void QCaSliderPlugin::useNewVariableNameProperty( QString variableNameIn, QString variableNameSubstitutionsIn, unsigned int variableIndex ) {
