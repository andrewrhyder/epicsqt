...
/*!
    ???
*/
QCaImagePlugin::QCaImagePlugin( QWidget* parent ) : QCaImage( parent )
{
    ...
    for( int i = 0; i < QCAIMAGE_NUM_VARIABLES; i++ )
    {
...
*/
void QCaImagePlugin::useNewVariableNameProperty( QString variableNameIn, QString variableNameSubstitutionsIn, unsigned int variableIndex )
{
