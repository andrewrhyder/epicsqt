...
class QCaLoginPlugin : public QCaLogin {
  ...
  public:
    ...
    enum UpdateOptions { Text     = QCaLogin::UPDATE_TEXT,
                         Picture  = QCaLogin::UPDATE_PIXMAP };
    void setUpdateOptionProperty( UpdateOptions updateOption ){ setUpdateOption( (QCaLogin::updateOptions)updateOption ); }
