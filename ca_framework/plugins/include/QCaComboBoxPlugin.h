/* $File: //ASP/Dev/SBS/4_Controls/4_8_GUI_Frameworks/4_8_2_Qt/sw/ca_framework/plugins/include/QCaComboBoxPlugin.h $
 * $Revision: #3 $
...
class QCaComboBoxPlugin : public QCaComboBox {
  ...
  public:
    ...
    QCaComboBoxPlugin( QString variableNameProperty = "", QWidget *parent = 0 );
    ...
    /// Qt Designer Properties - use database enumerations
    Q_PROPERTY(bool useDbEnumerations READ getUseDbEnumerationsProperty WRITE setUseDbEnumerationsProperty)
    void setUseDbEnumerationsProperty( bool useDbEnumerations ){ useDbEnumerationsProperty = useDbEnumerations; }
    bool getUseDbEnumerationsProperty(){ return useDbEnumerationsProperty; }
