/* $File: //ASP/Dev/SBS/4_Controls/4_8_GUI_Frameworks/4_8_2_Qt/sw/ca_framework/plugins/include/QCaComboBoxPluginManager.h $
 * $Revision: #2 $
...
class QCAPLUGINLIBRARYSHARED_EXPORT QCaComboBoxPluginManager : public QObject, public QDesignerCustomWidgetInterface {
  ...
  public:
    QCaComboBoxPluginManager( QObject *parent = 0 );
