...
/*! The QCaPvProperties class allows user to view all the displayalbe fields
...
class QCAPLUGINLIBRARYSHARED_EXPORT QCaPvProperties : public QFrame,
                                                      public QCaWidget {
   Q_OBJECT
...
public:
   /// Constructors
   //
   QCaPvProperties (QWidget * parent = 0);
   QCaPvProperties (const QString & variableName, QWidget * parent = 0);
   ~QCaPvProperties ();
