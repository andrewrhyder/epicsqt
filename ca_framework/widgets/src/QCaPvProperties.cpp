...
//==============================================================================
// QCaPvProperties class functions
//==============================================================================
//
QCaPvProperties::QCaPvProperties (QWidget * parent) :
      QFrame (parent),
      QCaWidget (this)
{
   this->recordBaseName = "";
...
//------------------------------------------------------------------------------
//
QCaPvProperties::QCaPvProperties (const QString & variableName, QWidget * parent) :
      QFrame (parent),
      QCaWidget (this)
{
...
//------------------------------------------------------------------------------
//
QCaPvProperties::~QCaPvProperties ()
{
   QCaString *qca;
...
//------------------------------------------------------------------------------
//
QSize QCaPvProperties::sizeHint () const {
   return QSize (300, 208);
}

//------------------------------------------------------------------------------
//
void QCaPvProperties::common_setup ()
{
   QComboBox *box;
   QLabel *timeStamp;
   QTableWidget *table;
   ...
   // Setup layout of widgets with the QCaPvProperties Qframe
   //
...
//
void QCaPvProperties::useNewVariableNameProperty (QString variableNameIn,
...
//------------------------------------------------------------------------------
//
void QCaPvProperties::setVariableNameAndSubstitutions (QString variableNameIn,
                                                       QString variableNameSubstitutionsIn,
                                                       unsigned int variableIndex)
{
...
//
void QCaPvProperties::updateToolTip (const QString& tip)
{
   setToolTip (tip);
}
...
//
void QCaPvProperties::clearFieldChannels ()
{
...
//------------------------------------------------------------------------------
//
qcaobject::QCaObject* QCaPvProperties::createQcaItem (unsigned int variableIndex)
{
...
//------------------------------------------------------------------------------
//
void QCaPvProperties::establishConnection (unsigned int variableIndex)
{
...
//------------------------------------------------------------------------------
//
void QCaPvProperties::setRecordTypeConnection (QCaConnectionInfo& connectionInfo)
{
...
//
void QCaPvProperties::setRecordTypeValue (const QString & rtypeValue,
                                          QCaAlarmInfo&,
                                          QCaDateTime&,
                                          const unsigned int&)
{
...
//------------------------------------------------------------------------------
//
void QCaPvProperties::setFieldConnection (QCaConnectionInfo& connectionInfo,
...
//------------------------------------------------------------------------------
//
void QCaPvProperties::setFieldValue (const QString &value,
...
//
void QCaPvProperties::requestEnabled (const bool & state)
{
...
// ComboBox
//
void QCaPvProperties::boxCurrentIndexChanged (int index)
{
   QComboBox *box = this->ownWidgets.box;
   QString newPvName;
   QString oldPvName;
...
// Drag drop
//
void QCaPvProperties::setDropText (QString text)
{
...
//------------------------------------------------------------------------------
//
QString QCaPvProperties::getDropText ()
{
...
//==============================================================================
//
void QCaPvProperties::setVariableNameProperty (QString variableName)
{
...
//----------------------------------------------------------------------------
//
QString QCaPvProperties::getVariableNameProperty ()
{
...
//----------------------------------------------------------------------------
//
void QCaPvProperties::setVariableNameSubstitutionsProperty (QString variableNameSubstitutions)
{
...
//----------------------------------------------------------------------------
//
QString QCaPvProperties::getVariableNameSubstitutionsProperty ()
{
...
//----------------------------------------------------------------------------
//
void QCaPvProperties::setVariableAsToolTip (bool variableAsToolTipIn)
{
...
//----------------------------------------------------------------------------
//
bool QCaPvProperties::getVariableAsToolTip ()
{
...
//
void QCaPvProperties::setAllowDrop (bool allowDropIn)
{
...
//----------------------------------------------------------------------------
//
bool QCaPvProperties::getAllowDrop ()
{
...
//----------------------------------------------------------------------------
//
void QCaPvProperties::setRunVisible (bool visibleIn)
{
   // Update the property
   //
...
//----------------------------------------------------------------------------
//
bool QCaPvProperties::getRunVisible ()
{
    return this->visible;
}
