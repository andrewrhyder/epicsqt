...
// precision
void QCaGenericButton::setPrecision( unsigned int precision )
{
    stringFormatting.setPrecision( precision );
}
unsigned int QCaGenericButton::getPrecision()
{
    return stringFormatting.getPrecision();
}

// useDbPrecision
void QCaGenericButton::setUseDbPrecision( bool useDbPrecision )
{
    stringFormatting.setUseDbPrecision( useDbPrecision);
}
bool QCaGenericButton::getUseDbPrecision()
{
    return stringFormatting.getUseDbPrecision();
}

// leadingZero
void QCaGenericButton::setLeadingZero( bool leadingZero )
{
    stringFormatting.setLeadingZero( leadingZero );
}
bool QCaGenericButton::getLeadingZero()
{
    return stringFormatting.getLeadingZero();
}

// trailingZeros
void QCaGenericButton::setTrailingZeros( bool trailingZeros )
{
    stringFormatting.setTrailingZeros( trailingZeros );
}
bool QCaGenericButton::getTrailingZeros()
{
    return stringFormatting.getTrailingZeros();
}

// addUnits
void QCaGenericButton::setAddUnits( bool addUnits )
{
    stringFormatting.setAddUnits( addUnits );
}
bool QCaGenericButton::getAddUnits()
{
    return stringFormatting.getAddUnits();
}

// format
void QCaGenericButton::setFormat( QCaStringFormatting::formats format )
{
    stringFormatting.setFormat( format );
}
QCaStringFormatting::formats QCaGenericButton::getFormat()
{
    return stringFormatting.getFormat();
}

// radix
void QCaGenericButton::setRadix( unsigned int radix )
{
    stringFormatting.setRadix( radix);
}
unsigned int QCaGenericButton::getRadix()
{
    return stringFormatting.getRadix();
}

// notation
void QCaGenericButton::setNotation( QCaStringFormatting::notations notation )
{
    stringFormatting.setNotation( notation );
}
QCaStringFormatting::notations QCaGenericButton::getNotation()
{
