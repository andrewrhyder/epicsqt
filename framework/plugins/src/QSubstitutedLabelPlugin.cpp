...
/*!
    ???
*/
QSubstitutedLabelPlugin::QSubstitutedLabelPlugin( QWidget* parent ) : QSubstitutedLabel( parent ) {
...
*/
void QSubstitutedLabelPlugin::useNewVariableNameProperty( QString variableNameIn, QString variableNameSubstitutionsIn, unsigned int variableIndex )
{
