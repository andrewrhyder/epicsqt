...
//------------------------------------------------------------------------------
//
int TimeZone::getZoneOffset (const QDateTime & atTime)
{
...
//------------------------------------------------------------------------------
//
QString TimeZone::getZoneTLA (const Qt::TimeSpec timeSpec, const QDateTime & atTime)
{
   QString result;
   int actualOffset;
   ...
   switch (timeSpec) {
      ...
      case Qt::LocalTime:
         ...
         //
         actualOffset = TimeZone::getZoneOffset (atTime);
