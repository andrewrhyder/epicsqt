...
if __name__ == "__main__":
	...
	try:
		...
		command = "svn add %s/tags/%s 1>/dev/null; svn commit %s/tags/%s -m \"Release version %s\" 1>/dev/null" % (base_path, new_release_version, base_path, new_release_version, new_release_version)
		#print command
		subprocess.call(command, shell = True)
	except KeyboardInterrupt:
		print ""
